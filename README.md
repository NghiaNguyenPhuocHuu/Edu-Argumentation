...
The **Edu-Argumentation / AWS Quiz App** is a lightweight, client-side web application designed to deliver interactive quizzes and educational modules (with a focus on AWS preparation domains) using a modular vanilla JavaScript architecture.
